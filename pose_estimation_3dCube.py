...
# retorna una imatge resultat de dibuixar un cub a img
...
# creem un cub donant les coordenades dels 8 vertex
...
# per a cada imatge, si apretem s ens permet guardar la imatge
